	...
	function GameSkin() {
		_super.call(this);
		this.skinParts = ["talkButton","microphoneButton","communityCardList","playGameButtonGroup","raiseSelector","startGameButton","pinLabel","cardTypeLabel","mainPotLabel","potsList","closeButton"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this._Image1_i(),this.talkButton_i(),this.microphoneButton_i(),this.communityCardList_i(),this.playGameButtonGroup_i(),this.raiseSelector_i(),this.startGameButton_i(),this.pinLabel_i(),this.cardTypeLabel_i(),this.mainPotLabel_i(),this.potsList_i(),this.closeButton_i()];
	}
