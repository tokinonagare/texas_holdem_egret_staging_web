	...
	function RaiseSelectorSkin() {
		_super.call(this);
		this.skinParts = ["background","shadow","confirmButton","dashboardButton","raiseSlider"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this.background_i(),this.shadow_i(),this.confirmButton_i(),this.dashboardButton_i(),this._Image1_i(),this.raiseSlider_i()];
	}
	...
	function GameSkin() {
		_super.call(this);
		this.skinParts = ["talkButton","microphoneButton","communityCardList","playGameButtonGroup","raiseSelector","dropdownButton","startGameButton","pinLabel","cardTypeLabel","mainPotLabel","potsList"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this._Image1_i(),this.talkButton_i(),this.microphoneButton_i(),this.communityCardList_i(),this.playGameButtonGroup_i(),this.raiseSelector_i(),this.dropdownButton_i(),this.startGameButton_i(),this.pinLabel_i(),this.cardTypeLabel_i(),this.mainPotLabel_i(),this.potsList_i()];
	}
	...
	_proto.dropdownButton_i = function () {
		var t = new eui.Button();
		this.dropdownButton = t;
		t.label = "";
		t.left = 20;
		t.rotation = 90;
		t.top = 20;
	...
	function LaunchSkin() {
		_super.call(this);
		this.skinParts = ["loginButton","visitorButton"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.loginButton_i(),this.visitorButton_i()];
	}
