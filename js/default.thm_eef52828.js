	...
	function GameSkin() {
		_super.call(this);
		this.skinParts = ["mainPotLabel","pinLabel","creatorLabel","blindLabel","talkButton","microphoneButton","communityCardList","startGameButton","cardTypeLabel","potsList","closeButton","playGameButtonGroup","raiseSelector"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this._Image1_i(),this.mainPotLabel_i(),this.pinLabel_i(),this.creatorLabel_i(),this.blindLabel_i(),this.talkButton_i(),this.microphoneButton_i(),this.communityCardList_i(),this.startGameButton_i(),this.cardTypeLabel_i(),this.potsList_i(),this.closeButton_i(),this.playGameButtonGroup_i(),this.raiseSelector_i()];
	}
	...
	function PlayerSkin() {
		_super.call(this);
		this.skinParts = ["winnerAnimation","avatarImage","nameLabel","scoreLabel","progressBorder","timerLabel","winnerBorder","cover"];
		
		this.height = 200;
		this.width = 140;
		this.winnerAnimation_i();
		this.elementsContent = [this._Image1_i(),this.avatarImage_i(),this.nameLabel_i(),this.scoreLabel_i(),this.progressBorder_i(),this.timerLabel_i(),this.winnerBorder_i(),this.cover_i()];
